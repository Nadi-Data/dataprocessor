...
if __name__ == "__main__":
    ...
    df2 = readparquetfile.ReadParquetFile(
        "/Users/sripri/Downloads/sample_without_partitions.parquet", engine='auto').read_using_dask()
    df3 = readparquetfile.ReadParquetFile(
        "/Users/sripri/Downloads/sample_with_partitions.parquet", engine='auto').read_using_dask()
    ...
    df_trailer = readtextfile.ReadTextFile(ipfile='/Users/sripri/Downloads/sample_textfile.txt',
                                           ipschemafile='/Users/sripri/Downloads/schema/sample_csv_file.txt',
